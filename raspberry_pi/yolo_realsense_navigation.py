#!/usr/bin/env python3
"""
Intelligent Navigation Assistant v3.29 HEADLESS
Builds on v3.28 with:
...
def main():
    ...
    print("=" * 70)
    print("INTELLIGENT NAVIGATION ASSISTANT v3.29 HEADLESS")
    print("RealSense D435 + YOLO26n + IMU + Piper TTS + Claude Vision + OpenAI STT")
    print("FIXES: push-to-talk voice commands, deterministic routing, nonblocking STT")
    print("=" * 70)
