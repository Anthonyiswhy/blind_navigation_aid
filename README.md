...
- Verified locally on April 27, 2026: `192 passed`
...
- `tests/test_blindnav_v326.py`: 155 tests
- Combined: 192 tests
...
- Review and merge the v3.29 repo state, then field-test it with Ricardo Salazar.
